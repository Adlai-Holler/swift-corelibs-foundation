...
public class NSAttributedString : NSObject, NSCopying, NSMutableCopying, NSSecureCoding {
    ...
    public func enumerateAttributesInRange(enumerationRange: NSRange, options opts: NSAttributedStringEnumerationOptions, @noescape usingBlock block: ([String : AnyObject], NSRange, UnsafeMutablePointer<ObjCBool>) throws -> Void) rethrows { NSUnimplemented() }
    public func enumerateAttribute(attrName: String, inRange enumerationRange: NSRange, options opts: NSAttributedStringEnumerationOptions, @noescape usingBlock block: (AnyObject?, NSRange, UnsafeMutablePointer<ObjCBool>) throws -> Void) rethrows { NSUnimplemented() }
}
