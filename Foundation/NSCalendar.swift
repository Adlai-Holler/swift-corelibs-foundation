...
public class NSCalendar : NSObject, NSCopying, NSSecureCoding {
    ...
    */
    public func enumerateDatesStartingAfterDate(start: NSDate, matchingComponents comps: NSDateComponents, options opts: NSCalendarOptions, @noescape usingBlock block: (NSDate?, Bool, UnsafeMutablePointer<ObjCBool>) throws -> Void) rethrows { NSUnimplemented() }
